...
def number_of_vehicle():
    ...
    if len(all_vehicles) > 1:
        ...
        for distance_in_metre in final_vehicle_result:
        	if distance_in_metre["distance"] > 10 and distance_in_metre["distance"] < 15:
        		...
        		dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.2))
        		time.sleep(3)
        		print("close car name :",distance_in_metre["vehicle_name"])
